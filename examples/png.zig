...
pub const Color = packed struct { r: u8, g: u8, b: u8, a: u8 };
...
pub const PNG = struct {
    ...
    pub fn decode(allocator: std.mem.Allocator, reader: anytype) !PNG {
    ...
    pub fn encode(self: *const PNG, allocator: std.mem.Allocator, writer: anytype) !void {
